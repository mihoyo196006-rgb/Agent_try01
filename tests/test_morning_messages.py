...
class MorningMessageTests(unittest.TestCase):
    def test_build_messages_returns_yesterday_summary_and_today_plan(self):
        ...
        self.assertIn("10:30-11:30 英语", messages[1])
        self.assertIn("11:30-12:30 论文", messages[1])
        self.assertIn("14:00-15:00 论文", messages[1])
        self.assertIn("17:00-18:00 论文", messages[1])
        self.assertIn("23:00-00:30 可选", messages[1])
