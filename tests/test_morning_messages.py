...
class MorningMessageTests(unittest.TestCase):
    ...
    def test_beijing_send_window_accepts_only_morning_calibration_window(self):
        self.assertTrue(is_beijing_send_window(datetime(2026, 6, 17, 1, 0, tzinfo=timezone.utc)))
        self.assertTrue(is_beijing_send_window(datetime(2026, 6, 17, 1, 10, tzinfo=timezone.utc)))
        self.assertTrue(is_beijing_send_window(datetime(2026, 6, 17, 1, 29, 59, tzinfo=timezone.utc)))
        ...
        self.assertFalse(is_beijing_send_window(datetime(2026, 6, 17, 0, 59, 59, tzinfo=timezone.utc)))
